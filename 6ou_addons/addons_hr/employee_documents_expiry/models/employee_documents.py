...
class HrEmployeeDocument(models.Model):
    ...
    def create(self, vals):
        ...
        # if vals.document_name.document_type == 'entry':
        #     result.employee_ref.write({'entry_ch  ecklist_ids': [(4, vals.document_name.id)]})
        # if vals.document_name.document_type == 'exit':
        #     result.employee_ref.write({'exit_checklist_ids': [(4, vals.document_name.id)]})
        return result
    # hima
    ...
    document_name = fields.Many2one('employee.checklist', string='Document2', required=False)
